...
def get_optimizer(algorithm: str, model: torch.nn.Module) -> Optimizer:
    """
    Gets the optimizer in the string algorithm and attaches it to model

    :param algorithm: str representing the algorithm
    :param model: the overall model to attach the optimizer
    :return: Optimizer
    :raises: NotImplementedError if you give an unsupported model
    """
